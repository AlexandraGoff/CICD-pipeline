pipeline {
 ...
 stages {
  ...
  stage('Publish image to Docker Hub') {
            ...
            steps {
        withDockerRegistry([ credentialsId: "dockerHub", url: "        withDockerRegistry([ credentialsId: "dockerHub", url: "https://hub.docker.com/repository/docker/alexgoffo200/pipeline" ]) {
